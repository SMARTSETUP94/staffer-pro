...
export const WIDGET_META: Record<WidgetId, WidgetMeta> = {
  ...
  astuces_marquee: {
    id: "astuces_marquee",
    title: "Bandeau astuces",
    description: "Toutes les astuces actives défilent en continu",
    category: "fun",
    width: 2,
  },
  quiz_du_jour: {
    id: "quiz_du_jour",
    title: "Quiz du jour",
    description: "Question avec scoring (points + streak)",
    category: "fun",
    width: 1,
  },
  quiz_leaderboard: {
    ...
    description: "Top 5 semaine / all-time avec médailles",
    category: "fun",
    width: 1,
  },
};
